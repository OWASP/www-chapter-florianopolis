...
Todos são bem-vindos e incentivados a participar de nossos [Projetos](https://www.owasp.org/projects/), [Local Chapters](https://www.owasp.org/chapters/), [Events](https://www.owasp.org/events/), [Online Groups](https://groups.google.com/a/owasp.com/) e [Canal Slack da comunidade](https://owasp.slack.com/). Encorajamos especialmente a diversidade em todas as nossas iniciativas. OWASP é um lugar fantástico para aprender sobre segurança de aplicativos, rede e até mesmo para construir sua reputação como especialista. Também encorajamos você a ser [tornar-se um membro](https://www.owasp.org/associação/) ou considerar uma [doação](https://www.owasp.org/donate/) para apoiar nosso trabalho contínuo.
...
***
## Sobre o Capítulo
O objetivo principal do Capítulo é fortalecer a comunidade de segurança de software em Santa Catarina através de conscientização, encontros e estudos de caso, representando a OWASP e seus objetivos.

* __Nossa visão:__ Através da conscientização e do repasse de conhecimento, nos tornarmos referência junto a comunidade de software no estado e ganhar reconhecido mundial junto a OWASP pela promoção ativa do capítulo.

***
## Nossos valores

* __Conscientização:__ O conhecimento precisa estar em constante movimento, para que através do processo educacional, consigamos sensibilizarmos, no que se refere a desenvolvimento seguro de software;

* __Transparência:__ Todas as ações do Chapter ocorrerão publicamente e poderão ser auditadas por qualquer membro da comunidade;

* __Colaboração__: Envolver a todos, no intuito de que cada membro possa se sentir parte do cápitulo;

* __Igualdade__: Todos temos talentos diferentes, mas todos gostaríamos de ter iguais oportunidades para desenvolver os nossos talentos, sendo assim, todos têm igualmente voz e direito de participação.

* __Ética__: Ética é o conjunto de padrões e valores morais de um grupo ou indivíduo, como tal, não abrimos mão deste item para o bom relacionamento e integrigade do cápitulo.

***
## Como Participar
As atividades e decisões do Capítulo são completamente horizontais e abertas à toda a comunidade, tanto para a participação como ouvintes, como também para apresentação de conteúdos ou sugestão de temas a serem discutidos, focando na transparência e divulgação de conhecimento de segurança de aplicações web dentro dos objetivos propostos pela OWASP. 
